    ...
    const routing = (
      <Router>
        ...
        <Switch>
          ...
          <Route path="/ThemesToExplore/Historical" exact component={Historical} />
          <Route path="/ThemesToExplore/WildLife" exact component={WildLife} />
          ...
          <Route path="/BookNow/:chargeAdult/:chargeChildren/:location/:date" exact component={Booking}/>
          <Route path="/SuccessMessage/:location/:noOfChild/:noOfAdults/:date" exact component={BookingSuccess}/>
